...
ok(missionRows === 27, 'twenty-seven JUD missions on the tree (SPEC §177, grown by §179, §183, §192, §200 and §211): ' + missionRows);
...
await page.evaluate(() => {
  ...
  document.querySelector('[data-ref="dipClaim"]').click();
