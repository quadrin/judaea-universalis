// Headless smoke test §207: the drumbeat of accomplishment.
//
...
// opened with a volley of medallions. §207 slows the drum: at most ONE
...
//
// §229 moved the PLAYER off this drum — a player's chain is claimed by hand
// now, and smoke154 pins that half. What is left here is the AI's half, which
...
console.log('== the rest rides the save; a pre-§207 save owes none ==');
{
  ...
  ok(old.tags.JUD.missionRest === 0, 'a pre-§207 save revives owing no rest');
}
