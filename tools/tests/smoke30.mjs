...
ok(!!snap.coastal[idOf('Eilat')] && nb('Eilat').has(idOf('Dizahab')),
...
ok(MODERN_NEGEV.every((n) => ancient.provinces[idOf(n)] === null),
  '66 CE has no hidden modern-Negev economy or victory land');
