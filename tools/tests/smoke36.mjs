// Headless regression — SPEC §57, retired by SPEC §180/§181.
//
...
// (`powerIn`), lapse-on-neglect, and the matériel purchases. §180 retired
// the system and §181 rebuilt the load-bearing parts on real tags: the
...
console.log('== §57 is retired (§180/§181) ==');
{
  ...
  ok(eco.indexOf('offmapIn') >= 0, 'the off-map stipend (§180) took the seam over');
