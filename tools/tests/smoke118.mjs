// Headless regression — SPEC §186: the ideas ride with the ladders that sell
...
// ---------------------------------------------------------------------------
console.log('== §186: the ideas render under the ladders ==');
{
...
// ---------------------------------------------------------------------------
console.log('== §186: nothing else moved ==');
{
...
// ---------------------------------------------------------------------------
console.log('== §186: for all bookmarks, every idea is paid by a ladder above it ==');
{
