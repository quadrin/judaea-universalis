// Headless regression — SPEC §247: the old names.
//
...
console.log('== §247 · 1 the list is well formed ==');
{
...
console.log('== §247 · 2 every chapter can raise something ==');
{
...
console.log('== §247 · 3 the table raises real countries ==');
...
console.log('== §247 · 4 the gates bite ==');
{
...
console.log('== §247 · 6 what is raised is a court ==');
{
...
console.log('== §247 · 7 the table shows it ==');
{
...
console.log(failures ? failures + ' FAILURES' : 'smoke167: ALL PASS');
