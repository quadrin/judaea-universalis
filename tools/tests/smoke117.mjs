// Headless regression — SPEC §184: the purse is somebody else's too.
//
...
console.log('== the save contract ==');
{
  ...
  ok(revivedOld && Array.isArray(revivedOld.subsidies), 'a pre-§184 save revives without a crash');
}

console.log(failures ? `smoke117: ${failures} FAILURES` : 'smoke117: ALL PASS');
