// Headless regression — SPEC §211: the constitutions a fork adopts.
//
...
console.log('== §211: every government declares what it is ==');
{
...
console.log('== §211: the engine reads the table, not the four old names ==');
{
...
console.log('== §211: the rules bite — succession, marriage, the crisis that cannot open ==');
{
...
console.log('== §211: no court silently becomes a monarchy ==');
{
...
console.log('== §211: every fork option lands on its constitution, fired live ==');
{
...
console.log('== §211: the roads are wired at the call site, where they can be read ==');
{
...
console.log('== §211: the helper refuses what it cannot do ==');
{
  const w = boot('66ce', 'JUD', 75);
