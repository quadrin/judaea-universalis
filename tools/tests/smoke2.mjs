...
// eleven since §183 seated the roads not taken beside them.
ok(ml.length === 27 && ml[0].status === 'done' && ml.some((m) => m.status === 'current'), 'getMissions statuses: ' + ml.map((m) => m.status).join(','));
...
console.log('== 132 CE bookmark boots and runs ==');
{
  ...
  ok(a4.getMissions().length === 28, 'JUD 132 missions present (incl. the Third House, SPEC §32, the §179 curriculum, the §192/§197 expansion, the §211 civil band, and the §183/§192/§197 roads not taken)');
