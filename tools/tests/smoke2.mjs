...
console.log('== 132 CE bookmark boots and runs ==');
{
  ...
  ok(a4.getMissions().length === 15, 'JUD 132 missions present (incl. the Third House, SPEC §32, the §179 curriculum, the §188 expansion, and the §183/§188 roads not taken)');
