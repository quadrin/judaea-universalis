...
// Eight nodes since SPEC §178 grew the chain its curriculum branches.
...
console.log('== 132 CE bookmark boots and runs ==');
{
  ...
  ok(a4.getMissions().length === 8, 'JUD 132 missions present (incl. the Third House, SPEC §32, and the §178 curriculum)');
