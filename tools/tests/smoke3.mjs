...
console.log('== 67 BCE: the Judaean Civil War ==');
{
  ...
  ok(a.getMissions().length === 29, 'HYR missions present (five objectives + the §179 curriculum + the §187/§197 expansion + the §210 civil band + the §183/§187/§197 roads not taken)');
