...
The battery on the merged tree — this branch merged with §257's own, which
landed on main first and took both the section number this one was drafted
under and the `smoke175` slot: **176 of 176 headless suites ALL PASS**, with
