...
## The constitutions a fork adopts (SPEC §213)

`smoke140` is the new headless suite. It holds three things that are easy to
...
seats fall back to the King's Men, and smoke140's court section says so by
