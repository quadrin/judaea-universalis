...
`smoke135.mjs` owns the SPEC §208 conversion: the Idumean cult of Qos seated
...
Hebron — the suite asserts `MAP_DATA` directly, because a §208 that leaked
...
Since SPEC §208 (Idumea keeps the cult of Qos until the covenant): the seeded
