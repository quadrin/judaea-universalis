...
## The constitutions a fork adopts (SPEC §210)

`smoke137` is the new headless suite. It holds three things that are easy to
...
seats fall back to the King's Men, and smoke137's court section says so by
