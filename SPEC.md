...
- **Government types** (`DEFINES.GOV_TYPES` + `GOV_OF` defaults +
  ...
  **Since §210 these four are the constitutions a bookmark can START with,
...
## 210. The fork decides what the state IS, not only what it does
...
- **Regression contract**: `smoke137` — the table (every government named,
