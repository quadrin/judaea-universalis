...
- **Government types** (`DEFINES.GOV_TYPES` + `GOV_OF` defaults +
  ...
  **Since §211 these four are the constitutions a bookmark can START with,
...
## 211. The fork decides what the state IS, not only what it does
...
- **Regression contract**: `smoke138` — the table (every government named,
