...
// ------------------------------------------------------------ constitutions
// What a court's government DOES, read off `DEFINES.GOV_TYPES` (SPEC §210).
//
...
export function switchTagCore(ctx, from, to) {
  ...
  // constitution says about inheriting (SPEC §210) is applied here rather than
...
export function royalMarriageInfo(ctx, tag, other) {
  ...
  // §210), so the adopted constitutions answer for themselves: a Temple-State
