...
// ------------------------------------------------------------ constitutions
// What a court's government DOES, read off `DEFINES.GOV_TYPES` (SPEC §211).
//
...
export function switchTagCore(ctx, from, to) {
  ...
  // constitution says about inheriting (SPEC §211) is applied here rather than
...
export function royalMarriageInfo(ctx, tag, other) {
  ...
  // §211), so the adopted constitutions answer for themselves: a Temple-State
