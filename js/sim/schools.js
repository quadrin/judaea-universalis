// Judaea Universalis — the religious quarrels (SPEC §190, §191). DOM-free.
//
// §190 built this for one quarrel and §191 made it every chapter's. The
...
// Which quarrel this court is having (SPEC §191). The bookmark maps a tag to a
  ...
  try {
    ...
    return {
      ...
      court: court.def ? {
        ...
        // strange one about an Israeli cabinet (SPEC §191).
