...
export const ICONS = {
  ...
  // --- toasts / modals --------------------------------------------------------
  // The Compendium: an open codex
  book:
    '<path d="M12 6.2C10.4 4.9 8.2 4.4 5 4.4v13.2c3.2 0 5.4.5 7 1.8 1.6-1.3 3.8-1.8 7-1.8V4.4c-3.2 0-5.4.5-7 1.8Z"/>' +
    '<path d="M12 6.2v13.2"/>' +
    '<path d="M7.2 8.2c1.5.1 2.7.4 3.6.9M7.2 11.2c1.5.1 2.7.4 3.6.9M13.2 9.1c.9-.5 2.1-.8 3.6-.9M13.2 12.1c.9-.5 2.1-.8 3.6-.9"/>',
  scroll:
