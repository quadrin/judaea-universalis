...
const RISING_LABELS = {
  ...
  function refreshDiplomacy(p, g) {
    ...
    // The chancery (SPEC §202): a standing bond takes a seat, and the seats
    ...
    if (d.marriage) {
      ...
      if (d.marriage.married) {
        ...
        // §202), so it needs a way out that is not a war.
        ...
        + (co.can
          ? (co.willAccept
            ...
            : '▸ They will refuse — devotion alone is not enough unless they are much smaller '
              ...
              + 'their goodwill.')
          : '')
        // The collar keeps the seat the alliance already held (SPEC §202) —
