    ...
    HER: [
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { infl: 60 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { treasury: 200 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { manpower: 3000 }),
      },
      {
        id: 'h5_city', name: 'The City of David',
        icon: 'temple', col: 1, requires: ['h5_coast', 'h5_galilee'],
        desc: 'Take Jerusalem.',
        rewardText: '+30 legitimacy — a crown made true.',
        check: (ctx) => ctx.helpers.controls(ctx, 'HER', 'Jerusalem'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { legitimacy: 30 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { stability: 1, legitimacy: 25 }),
      },
      ...
      },
      {
        ...
        desc: 'Take up three ideas of the age — a decree made him king; only statecraft keeps '
          + 'him one.',
        rewardText: '+60 influence points, +25 legitimacy.',
        check: (ctx) => eraTiers(ctx.game.tags.HER) >= 3,
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { infl: 60, legitimacy: 25 }),
      },
      ...
      // (SPEC §187): the Decapolis grants and the bandit country command.
      {
        ...
        desc: 'Take Gadara, Scythopolis and Pella — the Greek cities Augustus signed over to '
          + 'the king history\'s Herod, taken here by the king\'s own hand.',
        rewardText: '+240 talents of Greek customs, +35 influence points.',
        check: (ctx) => ['Gadara', 'Scythopolis', 'Pella']
          .every((n) => ctx.helpers.controls(ctx, 'HER', n)),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { treasury: 240, infl: 35 }),
      },
      {
        id: 'h5_hauran', name: 'The Trachonitis Command',
        icon: 'horseshoe', col: 2, row: 3, requires: ['h5_galilee'],
        desc: 'Take Batanea and Panion — the caravan-raiding country Augustus gave Herod to '
          + 'police, held at your own expense so Antioch does the arithmetic on what that '
          + 'saves.',
      ...
      // the Temple, the grain year, the fortresses, and the will.
      {
        ...
        desc: 'Hold Dora and Joppa with 450 talents banked to pay for it.',
      ...
      },
      {
        ...
        desc: 'Hold Jerusalem with 600 talents banked and Government 7 — this is an '
          + 'administrative feat before it is a religious one.',
        rewardText: '"The Temple of Herod": +0.3 legitimacy a month and +20% from the ascents, permanent.',
        check: (ctx) => ctx.helpers.controls(ctx, 'HER', 'Jerusalem')
          && ((ctx.game.tags.HER || {}).treasury || 0) >= 600
      ...
      },
      {
        ...
        desc: 'Reach +2 stability with 400 talents in hand — be able to do it before it is '
          + 'needed.',
      ...
      },
      {
        ...
        desc: 'Hold Masada and Machaerus.',
      ...
      },
      {
        ...
        desc: 'Raise Rome\'s regard to +180 — past devotion, where a kingdom stops being '
          + 'audited and starts being consulted.',
        rewardText: '"Socius et Amicus": +10% income permanently, +70 influence points.',
        check: (ctx) => {
        ...
        reward: (ctx) => {
          ...
          ctx.helpers.adjust(ctx, 'HER', { infl: 70 });
        },
      },
      {
        id: 'h5_a_dynasty_not_a_reign', name: 'A Dynasty, Not a Reign',
        icon: 'star8', col: 0, row: 5, requires: ['h5_famine_year'],
        desc: 'Reach 85 legitimacy and +3 stability: make the crown outlive the head wearing '
          + 'it.',
      ...
      // than Antigonus ever did.
      {
        ...
        desc: 'Embrace three institutions of the age: a client kingdom is administered in the '
          + 'age\'s own arts or it is administered badly.',
      ...
      },
      {
        ...
        desc: 'Raise the realm to 165 development with 700 talents banked: remit from strength '
          + 'or not at all.',
        rewardText: '"The Remitted Third": +10% town growth, −0.5 unrest everywhere, permanently.',
        check: (ctx) => realmDev(ctx, 'HER') >= 165
          && ((ctx.game.tags.HER || {}).treasury || 0) >= 700,
        reward: (ctx) => ctx.helpers.addTagModifier(ctx, 'HER', {
      ...
      },
      {
        ...
        desc: 'Stand among the four first powers of the world.',
        rewardText: '"The King the East Consulted": +1 diplomatic seat, +50 influence points.',
        check: (ctx) => {
        ...
        reward: (ctx) => {
          ...
          ctx.helpers.adjust(ctx, 'HER', { infl: 50 });
        },
      },
      {
        id: 'h5_the_peace_with_petra', name: 'The Peace With Petra',
        icon: 'dove', col: 1, row: 7, civil: 'region', requires: ['h5_among_the_powers'],
        desc: 'Raise Petra\'s regard to +60 and hold one sworn alliance.',
        rewardText: '"The Petra Settlement": +8% trade permanently, +200 talents of caravan custom.',
        ...
        reward: (ctx) => {
          ...
          ctx.helpers.adjust(ctx, 'HER', { treasury: 200 });
        },
      },
      {
        id: 'h5_the_alexandrian_priesthood', name: 'The Priesthood He Imported',
        icon: 'altar', col: 2, row: 6, civil: 'court',
        desc: 'Hold the House of Boethus at 70 approval; a bought altar is paid for every '
          + 'month.',
      ...
      },
      {
        ...
        desc: 'Bank 40 favour with the House of Antipater while the Sanhedrin stands at 60 '
          + 'approval.',
      ...
      // ── The roads not taken (SPEC §183) ─────────────────────────────────
      {
        ...
        desc: 'Break Antigonus, keep Jerusalem, answer to no overlord — and then take Damascus '
          + 'or Petra.',
        rewardText: '+60 influence points, +200 talents.',
        check: (ctx) => {
      ...
      },
      {
        ...
        rewardText: '+40 legitimacy, +2 stability.',
        check: (ctx) => anyFlag(ctx, 'kingdomWhole'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'HER', { legitimacy: 40, stability: 2 }),
      },
],
    ATG: [
      {
        ...
        icon: 'spears', col: 1,
        desc: 'Keep 14,000 men under arms.',
        rewardText: '+3,000 manpower.',
        check: (ctx) => totalMen(ctx, 'ATG') >= 14000,
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { manpower: 3000 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { mar: 60 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { infl: 60 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { legitimacy: 25 }),
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { stability: 1, legitimacy: 25 }),
      },
      ...
      // age's hired steel and crowns the dynasty's own ideas.
      {
        ...
        rewardText: '"The Companies Retained": +15% reinforcement speed permanently.',
        check: (ctx) => (((ctx.game.tags.ATG || {}).tech || {}).mar | 0) >= 6,
        reward: (ctx) => ctx.helpers.addTagModifier(ctx, 'ATG', {
          id: 'companies_retained', name: 'The Companies Retained', months: -1, effects: { reinforceMult: 1.15 },
        }),
      },
      {
        id: 'a5_hasmonean_charter', name: 'The Hasmonean Charter',
        icon: 'scroll', col: 2, requires: ['a5_anointed'],
        desc: 'Take up three ideas of the age — the blood claims the crown; the ideas must '
          + 'keep it.',
        rewardText: '+60 governance points, +15 legitimacy.',
        check: (ctx) => eraTiers(ctx.game.tags.ATG) >= 3,
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { gov: 60, legitimacy: 15 }),
      },
      ...
      // the Damascus road, and a restored house is measured against his map.
      {
        ...
        desc: 'Take Gaza, Ascalon and Azotus from the pretender — the ports your grandfather '
          + 'held, and the customs silver his wars ran on.',
        rewardText: '+200 talents of customs silver.',
        check: (ctx) => ['Gaza', 'Ascalon', 'Azotus']
          .every((n) => ctx.helpers.controls(ctx, 'ATG', n)),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { treasury: 200 }),
      },
      {
        id: 'a5_damascus', name: 'The Ghost of Coele-Syria',
        icon: 'flag', col: 2, row: 3, requires: ['a5_hasmonean_charter'],
        desc: 'Take Damascus — the city that once offered itself to your house against the '
          + 'Itureans, held now by whichever empire is passing through.',
        rewardText: '+60 martial points, +15 legitimacy.',
        check: (ctx) => ctx.helpers.controls(ctx, 'ATG', 'Damascus'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { mar: 60, legitimacy: 15 }),
      },
      ...
      // the century the chronicles gave to somebody else.
      {
        ...
        desc: 'Bank 400 talents and strike the bilingual coin — Mattathias the High Priest in '
          + 'Hebrew, King Antigonus in Greek.',
        rewardText: '"The Two Alphabets": +8% income and +0.15 legitimacy a month, permanent.',
        check: (ctx) => ((ctx.game.tags.ATG || {}).treasury || 0) >= 400,
        reward: (ctx) => ctx.helpers.addTagModifier(ctx, 'ATG', {
      ...
      },
      {
        ...
        desc: 'Take Masada and Machaerus, and the restoration has no back door left open for '
          + 'the Idumean to come back along.',
      ...
      },
      {
        ...
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { manpower: 6000, stability: 1 }),
      },
      {
        id: 'a5_the_priest_king_settled', name: 'The Priest-King Settled',
        icon: 'scales', col: 2, row: 4, requires: ['a5_damascus'],
        desc: 'Reach Government 7 and +2 stability: govern the quarrel instead of surviving '
          + 'it.',
      ...
      },
      {
        ...
        desc: 'Outlast the decree: raise Rome\'s regard for the restored house to +80.',
        rewardText: '+70 influence points, +30 legitimacy.',
        check: (ctx) => {
          const rom = ctx.game.tags.ROM;
          return ((rom && rom.opinion && rom.opinion.ATG) || 0) >= 80;
        },
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { infl: 70, legitimacy: 30 }),
      },
      // ── The civil band (SPEC §211) ──────────────────────────────────────
      ...
      // which are the one asset an Idumean with a Senate decree cannot buy.
      {
        ...
        desc: 'Take three reforms of the Art of Rule — the census, the governors, the '
          + 'granaries of state.',
      ...
      },
      {
        ...
        desc: 'Raise the realm to 350 development with 700 talents banked — the whole country '
          + 'working, and the silver sitting on a rock.',
        rewardText: '"The Silver in the Rocks": upkeep a tenth cheaper, +6% income, permanently.',
        check: (ctx) => realmDev(ctx, 'ATG') >= 350
          && ((ctx.game.tags.ATG || {}).treasury || 0) >= 700,
        reward: (ctx) => ctx.helpers.addTagModifier(ctx, 'ATG', {
      ...
      },
      {
        ...
        desc: 'Raise Parthia\'s regard for the restored house to +100 — a patron who has '
          + 'stopped counting.',
        rewardText: '"The Lances Remember": +10% manpower permanently, +50 martial points.',
        ...
        reward: (ctx) => {
          ...
          ctx.helpers.adjust(ctx, 'ATG', { mar: 50 });
        },
      },
      {
        ...
        desc: 'Swear a second alliance, or take a client crown of your own: a house with '
          + 'friends is a house Rome must negotiate with.',
        ...
        reward: (ctx) => {
          ...
          ctx.helpers.adjust(ctx, 'ATG', { manpower: 4000 });
        },
      },
      {
        id: 'a5_the_courses_of_the_altar', name: 'The Courses of the Altar',
        icon: 'altar', col: 2, row: 6, civil: 'court',
        desc: 'Hold the priesthood at 75 approval — the ephod is an office before it is an '
          + 'argument.',
      ...
      },
      {
        ...
        desc: 'Bank 40 favour with the priesthood and hold the street at 70.',
      ...
      // ── The roads not taken (SPEC §183) ─────────────────────────────────
      {
        ...
        desc: 'Hold Jerusalem against the Senate\'s decree and the legions\' schedule.',
        rewardText: '+30 legitimacy, +60 martial points.',
        check: (ctx) => anyFlag(ctx, 'hasmoneanHolds'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { legitimacy: 30, mar: 60 }),
      },
      {
        id: 'hy_statue_kingdom', name: 'The Order Never Given', hypothetical: true,
        fork: '40bce/the_statue',
        ...
        rewardText: '+25 legitimacy, +1 stability.',
        check: (ctx) => anyFlag(ctx, 'orderNeverGiven', 'refusedInAdvance'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { legitimacy: 25, stability: 1 }),
      },
      {
        id: 'hy_queens_portion', name: 'The Queen\'s Portion', hypothetical: true,
        fork: '40bce/the_queens_portion',
      ...
      },
      {
        ...
        rewardText: '+40 legitimacy, +2 stability.',
        check: (ctx) => anyFlag(ctx, 'kingdomWhole'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ATG', { legitimacy: 40, stability: 2 }),
      },
],
    ...
    ADI: [
      {
        ...
        desc: 'Pacorus is in Syria and every ford is a muster point. Put 8,500 men under the '
          + 'house\'s standards.',
        rewardText: '"The Tide\'s Riders": +8% morale permanently.',
        check: (ctx) => totalMen(ctx, 'ADI') >= 8500,
        reward: (ctx) => ctx.helpers.addTagModifier(ctx, 'ADI', {
          id: 'tides_riders', name: 'The Tide\'s Riders', months: -1, effects: { moraleMult: 1.08 },
        }),
      },
      {
        id: 't5_customs_frontier', name: 'The Customs Frontier Moves West',
        icon: 'coins', col: 2, requires: ['t5_tide_riders'],
        desc: 'Every conquest of Pacorus moves the tolls west with it. Bank 450 talents of the '
          + 'widened road\'s custom.',
      ...
      },
      {
        ...
        desc: 'Pacorus counts his clients by their lances. Reach the King of Kings\' full '
          + 'regard — opinion of the house at +100.',
      ...
      },
      {
        ...
        desc: 'The tide breaks somewhere in Syria, one summer soon. Be seated at Arbela when '
          + 'the survivors ride home — from the middle of 38, still holding.',
      ...
      },
      {
        ...
        desc: 'Bank 400 talents so the vow can be paid when it is sworn.',
        rewardText: '"The Lamp Over the Door": +5% from the ascents permanently, +15 legitimacy.',
      ...
      },
      {
        ...
        desc: 'Take Tyre, and lay the one city the invasion could not reach at the King of '
          + 'Kings\' feet.',
      ...
      // prays to in front of the men who hold its lances.
      {
        ...
        desc: 'Embrace three institutions of the age and carry the house to 55 development — '
          + 'Greek accounts on the same table as Aramaic contracts.',
      ...
      },
      {
        ...
        desc: 'Bring Rome\'s regard for Arbela to +25 — off the enemy list entirely.',
      ...
      },
      {
        ...
        desc: 'Hold the fire priests at 70 approval with 35 favour banked among the caravan '
          + 'lords.',
      ...
      },
      {
        ...
        desc: 'A merchant named Ananias will teach the Law at Charax in this chapter\'s span, '
          + 'and the house\'s new prayers will need an address.',
        rewardText: '+25 legitimacy, +25 influence points.',
        check: (ctx) => anyFlag(ctx, 'orderNeverGiven', 'refusedInAdvance'),
        reward: (ctx) => ctx.helpers.adjust(ctx, 'ADI', { legitimacy: 25, infl: 25 }),
      },
    ],
  },
